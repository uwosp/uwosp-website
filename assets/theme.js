...
theme.fitNav = function() {
  ...
  theme.cache.$window.on('resize', controlNav);
  ...
  function controlNav() {
    ...
    if (navItemWidth > navWidth) {
      ...
      theme.cache.$siteNav.parent().removeClass('large--one-sixth').addClass('large--two-thirds');	// added
      theme.cache.$siteNavOpen.removeClass('site-nav--open__display');
      theme.cache.$siteNavOpen.parent().addClass('large--hide');
      theme.cache.$logoWrapper.parent().removeClass('large--two-thirds').add('large--one-third');	// added
      theme.cache.$logoWrapper.removeClass('text-center').addClass('large--left');					// added
 ...
 * https://shopify.dev/tutorials/customize-theme-open-external-links-in-new-browser
 */
